...
#startbage to searx
c.url.start_pages = 'https://fosstodon.org'
...
config.bind('xb', 'config-cycle statusbar.show always switching')
...
### Colourscheme copy base16 theme in here:
